  ...
  <div class="font-sans text-gray-800 leading-normal flex flex-col min-h-screen">
    ...
    <footer class="bg-blue-700 text-white">
      <div class="container mx-auto flex flex-col sm:flex-row items-center justify-between py-8">
        <div class="mb-8 sm:mb-0">Copyright 2019. All rights reserved.</div>
        <ul class="flex items-center">
          <li class="mr-8">
            <a href="mailto:davidli012345:me@gmail.com" class="text-white hover:text-gray-400">
          ...
          <li class="mr-8">
            <a href="https://github.com/FriendlyUser/gridsome-app-starter" target="_blank" class="text-white hover:text-gray-400">
    ...
    <!--Consider Adding Timeline Component see https://codepen.io/tutsplus/pen/ZKpNwm-->
